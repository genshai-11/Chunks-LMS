 ...
 * Learners use scoped links rather than staff Supabase Auth; staff copies invites from the roster.
 * Learner Auth accounts remain outside this V1 flow.
 */
  ...
  return (
    <div className="access-page">
      <PageHeader
        ...
        subtitle="Use the invite link from your teacher, or type the exact email on your learner profile. Staff Supabase sign-in is separate."
      />
      ...
      {current ? (
        <Panel icon={GraduationCap} title="Portal open" description="Continue to your classes.">
          <div className="access-current">
            ...
            <button type="button" className="ghost" onClick={() => setActiveLearnerUserId(null)}>
      ...
      >
        ...
        {error ? (
          <p className="banner err mt-3" role="alert">
            {error}
          </p>
        ) : null}
      </Panel>
